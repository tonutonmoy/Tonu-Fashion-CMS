...
<aside id="cart-sidebar" class="fixed top-0 right-0 h-full w-full max-w-md bg-white shadow-2xl z-[70] transform translate-x-full transition-transform duration-300 flex flex-col" data-turbo-permanent aria-label="Shopping cart">
    ...
    <div class="border-t border-gray-200 p-4 space-y-3 bg-gray-50">
        ...
        <a href="<?php echo e(route('checkout.index')); ?>" class="btn-primary w-full text-center block">Checkout</a>
        <a href="<?php echo e(route('cart.index')); ?>" class="btn-secondary w-full text-center block">View full cart</a>
    </div>
</aside>
<?php /**PATH D:\PROGECTS\LARAVEL-PHP\E-mommarz\Fashion-Templete\resources\views/themes/shared/partials/cart-sidebar.blade.php ENDPATH**/ ?>