...
<aside id="cart-sidebar" class="fixed top-0 right-0 h-full w-full sm:max-w-md bg-white shadow-2xl z-[70] transform translate-x-full transition-transform duration-300 flex flex-col" data-turbo-permanent aria-label="Shopping cart">
    <div class="flex items-center justify-between p-4 border-b border-gray-200">
        <h2 class="text-lg font-semibold">Your Cart</h2>
        <button type="button" id="cart-sidebar-close" class="theme-icon-btn" aria-label="Close cart">
