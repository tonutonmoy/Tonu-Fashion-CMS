...
@endphp
@if(($social['whatsapp_enabled'] ?? false) && ($social['whatsapp_number'] ?? null))
<a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $social['whatsapp_number']) }}" target="_blank" rel="noopener" class="social-chat-btn social-chat-whatsapp" aria-label="WhatsApp" title="WhatsApp">
...
@endif
@if(($social['messenger_enabled'] ?? false) && ($social['messenger_link'] ?? null))
<a href="{{ $social['messenger_link'] }}" target="_blank" rel="noopener" class="social-chat-btn social-chat-messenger" aria-label="Messenger" title="Messenger">💬</a>
@endif
@if(($social['instagram_enabled'] ?? false) && ($social['instagram_link'] ?? null))
<a href="{{ $social['instagram_link'] }}" target="_blank" rel="noopener" class="social-chat-btn social-chat-instagram" aria-label="Instagram" title="Instagram">📷</a>
@endif
@if(($social['telegram_enabled'] ?? false) && ($social['telegram_link'] ?? null))
<a href="{{ $social['telegram_link'] }}" target="_blank" rel="noopener" class="social-chat-btn social-chat-telegram" aria-label="Telegram" title="Telegram">✈️</a>
@endif
<style>
